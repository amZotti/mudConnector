...
render_world.mark_character_coordinates(WORLD, [2,2]) #I know hardcoding this is kind of ghetto, but in the next step or 2 I am going to put the players coordinates in database/models so they can be accessed directly with current_user.character.coordinates instead of passing around parameters.
